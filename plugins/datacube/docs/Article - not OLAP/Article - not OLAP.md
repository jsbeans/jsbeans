...
_В зависимости от реакции и предпочтений читателей, и решения модератора, в следующих статьях мы с радостью раскроем другие стороны некоторых интересных архитектурных решений нашей команды – конструируемую подсистему визуализации, аналитические процессы, онтологический конструктор предметных областей, язык запросов, импорт данных и что-то еще..._
