...
Начиная создавать систему малыми силами, мы пошли от простого к сложному. Создавая конструктор, мы были внутренне убеждены, что мы хорошо понимаем цель системы, борясь одновременно с желанием не делать лишнего и противоположным желанием автоматизировать всё и вся, для всего создавая фреймворк. Тем более, что один замечательный фреймворк был уже готов и даже обкатан в продакшене - jsBeans. Итак, мы приступили к разработке очередной системы обработки данных, которая выросла и сейчас представляет собой одновременно и самодостаточный продукт - конструктор, и платформу для разработки целого класса систем обработки данных - условно будем называть ее "Кубик-Рубика", чтобы не было рекламы.
...
_Рис 2. Пример редактора модели данных куба_
...
_Рис 4. Пример редактора среза_
...
_Рис 5. Пример глобального фильтра на дашборде_



![mosedu-filter-json](mosedu-filter-json.png)

_Рис 6. Пример глобального фильтра в JSON_



![mosedu-filter-sql](mosedu-filter-sql.png)

_Рис 7. Пример финального SQL запроса со встроенными фильтрами_
