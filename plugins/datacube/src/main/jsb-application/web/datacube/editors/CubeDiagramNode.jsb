			...
			if(field){
				...
				var leftConnector = $this.installConnector('cubeFieldLeft', {
					...
					onChangeConnection: function(link){
						...
						$this.entry.server().linkField(field, provider, pField, rDesc.node.fields[pField], function(desc){
							if(!$this.fields){
								$this.fields = {};
							}
							if(desc.link){
				...
				var welcomeConnector = $this.installConnector('cubeFieldLeft', {
					...
					onChangeConnection: function(link){
						...
						$this.entry.server().addField(provider, field, rDesc.node.fields[field], function(desc){
							if(!$this.fields){
								$this.fields = {};
							}
