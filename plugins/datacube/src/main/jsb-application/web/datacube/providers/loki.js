...
(function (root, factory) {
  ...
  return (function () {
    ...
    Loki.prototype.autosaveEnable = function (options, callback) {
      ...
      this.autosaveHandle = JSB().Window.setInterval(function autosaveHandleInterval() {
    ...
    Loki.prototype.autosaveDisable = function () {
      if (typeof (this.autosaveHandle) !== 'undefined' && this.autosaveHandle !== null) {
        JSB().Window.clearInterval(this.autosaveHandle);
        this.autosaveHandle = null;
      }
    };
    ...
    Collection.prototype.setTTL = function (age, interval) {
      if (age < 0) {
    	  JSB().Window.clearInterval(this.ttl.daemon);
      } else {
        this.ttl.age = age;
        this.ttl.ttlInterval = interval;
        this.ttl.daemon = JSB().Window.setInterval(this.ttlDaemonFuncGen(), interval);
      }
    };
