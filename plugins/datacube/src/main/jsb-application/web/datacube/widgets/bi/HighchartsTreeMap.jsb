{
	$name: 'DataCube.Widgets.HighchartsTreeMap',
	...
	$client: {
		...
		$constructor: function(opts){
			...
			this.loadCss('HighchartsTreeMap.css');
			//JSB().loadScript(['tpl/highstock/adapters/standalone-framework.js'], function(){
				JSB().loadScript('tpl/highstock/modules/heatmap.js', function(){
        ...
        convertToTreemapFormat: function(data, array, parent){
            ...
            for(var i = 0; i < data.length; i++){
                ...
                array.push({
                    ...
                    parent: parent,
                    value: data[i].weight,
                    colorValue: parseInt(data[i].weight, 10)
                });
