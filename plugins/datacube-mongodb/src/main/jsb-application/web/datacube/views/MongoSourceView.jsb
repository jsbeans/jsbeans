{
	$name: 'DataCube.MongoSourceView',
	$parent: 'JSB.Workspace.BrowserView',
	
	$expose: {
		priority: 1,
		acceptNode: 'DataCube.MongoSourceNode',
		acceptEntry: 'DataCube.Model.MongoSource',
		caption: 'Настройки',
			...
			this.append(`#dot
				<div jsb="JSB.Widgets.ScrollBox">
					<div jsb="JSB.Widgets.GroupBox" caption="Настройки соединения" class="connectionSettings">
						...
						<div class="option useAuth" jsb="JSB.Controls.Checkbox" label="Использовать аутентификацию" checked="false"
