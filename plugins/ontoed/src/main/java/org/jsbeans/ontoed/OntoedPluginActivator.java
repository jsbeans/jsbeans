...
package org.jsbeans.ontoed;

import org.jsbeans.helpers.ConfigHelper;
import org.jsbeans.plugin.PluginActivator;

public class OntoedPluginActivator implements PluginActivator {

    @Override
    public void init() {
        String path = ConfigHelper.getPluginHomeFolder(this) + "/" + ConfigHelper.getConfigString("ontoed.folder");
