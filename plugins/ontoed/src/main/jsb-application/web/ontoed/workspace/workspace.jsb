JSB({
	name:'Ontoed.Workspace',
	parent: 'JSB.Widgets.Actor',
	require: ['Ontoed.Model.Ontology', 'Ontoed.Model.SpinOntology'],
	fixedId: true,
	...
	server: {
		...
		setCurrentOntology: function(onto){
			this.currentOntology = onto;
		},
		
		getCurrentOntology: function(){
		...
		createOntologyFromContent: function(name, category, content){
			...
			try {
                ...
                var text = utils.loadTextFile('/home/user/dev/ontologies/general/OPO.ttl');
                utils.storeTextFile('/home/user/dev/ontologies/general/OPO.ttl.text', text);
                utils.storeTextFile('/home/user/dev/ontologies/general/OPO.ttl.content', content);
