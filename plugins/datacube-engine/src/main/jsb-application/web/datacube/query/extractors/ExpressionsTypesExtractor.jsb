{
	...
	$server: {
		$require: [
		    'DataCube.Query.Extractors.ExpressionsTypesVisitor',
        ...
        extractedTypes: function(rootQuery, callback){
            try{
                var extractor = new ExpressionsTypesVisitor(rootQuery);
                extractor.extract();

                if (callback) {
                    callback(extractor.queryFieldTypeMap, extractor.expressionTypeMap);
                }
                return extractor.queryFieldTypeMap;
            } finally {
...
//                    if (!queryFieldTypeMap.containsKey(query)) {
//                        var fieldTypes = {};
...
//                        var query = this.getQuery();
//                        queryFieldTypeMap.get(query)[alias] = copyType(this.type);
//                        this.type = null;
//                    },
//                },
//                param: {
...
//                        }
//                        this.type = copyType(queryFieldTypeMap.get(sourceQuery)[field]);
//                    },
//                },
//                expression: {
//                    before: function(exp){
