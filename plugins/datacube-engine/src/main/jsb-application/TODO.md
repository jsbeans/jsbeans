...
- при выборе измерений тултип мешается и содержит бесполезный текст, полностью дублирующий текст под ним
...
- добавить появляющиеся элементы с выбранными в данный момент срезами, своего рода живой список выбранных элементов
- Ошибка: если срез с первого раза не добавился на диаграмму, то должна быть возможность его повторно туда перетащить из воркспейса с восстановлением связей, если они есть на диаграмме    
