...
CodeMirror.defineMode("rpm-spec", function() {
  ...
  var preamble = /^(Name|Version|Release|Licence|Summary|Url|Group|Source|BuildArch|BuildRequires|BuildRoot|AutoReqProv|Provides|Requires(\(\w+\))?|Obsoletes|Conflicts|Recommends|Source\d*|Patch\d*|ExclusiveArch|NoSource|Supplements):/;
